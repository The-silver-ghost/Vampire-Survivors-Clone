...
#enter area
func _on_area_left_body_entered(_body:CharacterBody2D):
	InfiniteMap.left = true
	InfiniteMap.positionChange = true
	InfiniteMap.xAxis -= 1


func _on_area_right_body_entered(_body:CharacterBody2D):
	InfiniteMap.right = true
	InfiniteMap.positionChange = true
	InfiniteMap.xAxis += 1


func _on_area_up_body_entered(_body:CharacterBody2D):
	InfiniteMap.up = true
	InfiniteMap.positionChange = true
	InfiniteMap.yAxis -= 1


func _on_area_down_body_entered(_body:CharacterBody2D):
